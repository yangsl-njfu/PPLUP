    ...
    try:
        ...
        while True:
            ...
            step_diagnostic = {
                ...
                "selected_lateral_delta": safety_info.get("selected_lateral_delta", 0.0),
                "dynamic_blocker_overtake_required": safety_info.get("dynamic_blocker_overtake_required", False),
                "dynamic_blocker_overtake_selected": safety_info.get("dynamic_blocker_overtake_selected", False),
                "selected_terminal_passed_blocker": safety_info.get("selected_terminal_passed_blocker", False),
                "selected_terminal_recoverable": safety_info.get("selected_terminal_recoverable", False),
                "blocker_left_gap": safety_info.get("blocker_left_gap", 0.0),
                "blocker_right_gap": safety_info.get("blocker_right_gap", 0.0),
