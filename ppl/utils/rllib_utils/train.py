...
import numpy as np
from ppl.utils.rllib_utils.callbacks import DrivingCallbacks
from ppl.utils.rllib_utils.utils import initialize_ray
...
def train(
    ...
    **kwargs
    ...
    if wandb_project is not None:
        ...
        failed_wandb = False
        try:
            from ppl.utils.rllib_utils.ray_wandb_callbacks import OurWandbLoggerCallback
        ...
        if failed_wandb:
            ...
            from ppl.utils.rllib_utils.ray_wandb_callbacks_ray100 import OurWandbLogger
